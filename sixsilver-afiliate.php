...
function register_products_shortcode($atts) {
    ...
    foreach ($products as $product) {
        ...
        if($product['type'] == 'variable'){
            ...
            if($product['baselinker_variations'][0]['sale_price'] != '') $sale_price = $product['baselinker_variations'][0]['sale_price'];
        } else if($product['type'] == 'simple'){
            if($product['regular_price'] != '') $regular_price = $product['regular_price'];
            else $regular_price = $product['price'];
            if($product['sale_price'] != '') $sale_price = $product['sale_price'];
        }
